        ...
        if(isset($_REQUEST)){
            if(isset($_GET["login"])){
                if($_GET["login"]=="false"){
                    ...
                    echo    "<script>
                                    notificao('gleam','Ação não permitida','danger');
                            </script>";
                }
            }
        }
    ...
    <div class='col-md-4'>
        ...
        <div id="dp" class="dprincipal" align="center">
            ...
            <form id="flogin" action='home.php' method="POST">
                ...
                <div class="form-group">
                    <a id="rpass" href="#">Esqueci minha senha</a>
                </div>
        ...
        <div id="rc" class="hidden" align="center">
            ...
            <form id="frSenha">
                <div class="form-group">
                    <input class="form-control" type="text" id="us-email"
                        placeholder="Usuário ou e-mail" required autofocus align="center">
                </div>
                <div class="form-group">
